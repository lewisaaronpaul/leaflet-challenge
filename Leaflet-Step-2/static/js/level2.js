...
function createMap(earthquakes) {
    ...
    // Use this link to get the geojson data for the faultlines.
    const link = "static/data/qfaults_latest_quaternary.geojson";
    ...
    d3.json(link, function (data) {
        ...
        L.geoJson(data.features, {
            ...
            style: function (faultlineFeature) {
                return {
                    fillOpacity: 0.7,
                    weight: 8,
                    color: "red"
            ...
            onEachFeature(feature, layer) {
                layer.bindPopup("<h3>Fault: " + feature.properties.fault_name + "</h3><hr><p>Location: " + feature.properties.Location + "</p><hr><p>Line Type: " + feature.properties.linetype + "</p><hr><p>Slip Rate: " + feature.properties.slip_rate + "</p>");
            }
    ...
    const myMap = L.map("map", {
        center: [16.97, -7.99],
        zoom: 1.5,
        layers: [streetmap, faultLine, earthquakes]
    });
